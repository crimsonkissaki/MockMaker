...
class MockMaker
{
	 ...
	 * get arguments & arg types for each method? (ReflectionFunction->getParameters())
	 *	- insert into setter methods
	 * hide static functions from being pulled up in their "family" array?
	 */
