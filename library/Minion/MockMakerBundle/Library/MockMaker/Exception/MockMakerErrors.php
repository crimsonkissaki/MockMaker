...
class MockMakerErrors
{
	...
	const WRITE_DIR_INVALID_PERMISSIONS_MSG = "Provided write directory (%dir%) has insufficient permissions for writing.";
	const READ_DIR_NOT_EXIST = "READ_DIR_NOT_EXIST";
	const READ_DIR_NOT_EXIST_MSG = "Provided read directory (%dir%) does not exist.";
	const READ_DIR_INVALID_PERMISSIONS = "READ_DIR_INVALID_PERMISSIONS";
	const READ_DIR_INVALID_PERMISSIONS_MSG = "Provided read directory (%dir%) has insufficient permissions for reading.";
